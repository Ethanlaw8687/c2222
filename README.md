...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/Ethanlaw8687/c2222) 
...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示`Your app was successfully deployed` 
  ...
  * 默认协议密码为`498ad6c4-764d-861a-cd64-f02164ba20bb`，WS路径为$UUID-[vmess|vless|trojan|ss|socks]格式

### 客户端
* **务必替换所有的`xxx.herokuapp.com`为heroku分配的项目域名**  
* **务必替换所有的`498ad6c4-764d-861a-cd64-f02164ba20bb`为部署时设置的UUID,建议更改,不要每个人都一样**  
...
* 端口：443
* 默认UUID：498ad6c4-764d-861a-cd64-f02164ba20bb
* vmess额外id：0
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 伪装域名：xxx.workers.dev(CF Workers反代地址)
* 路径：/498ad6c4-764d-861a-cd64-f02164ba20bb-vless // 默认vless使用(/自定义UUID码-vless)，vmess使用(/自定义UUID码-vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "498ad6c4-764d-861a-cd64-f02164ba20bb"
    ],
    "websocket": {
        "enabled": true,
        "path": "/498ad6c4-764d-861a-cd64-f02164ba20bb-trojan",
...
* 端口: 443
* 密码：498ad6c4-764d-861a-cd64-f02164ba20bb
* 加密：chacha20-ietf-poly1305
* 插件程序：xray-plugin_windows_amd64.exe  //需将插件https://github.com/shadowsocks/xray-plugin/releases下载解压后放至shadowsocks同目录
* 插件选项: tls;host=xxx.herokuapp.com;path=/498ad6c4-764d-861a-cd64-f02164ba20bb-ss
```
</details>
